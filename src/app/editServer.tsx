...
const EditServer: React.FC = () => {
  ...
  const [serverType, setServerType] = useState<ServerType>(serverToEdit ? serverToEdit.type : ServerType.Minecraft);
  const [displayName, setDisplayName] = useState<string>(serverToEdit ? serverToEdit.displayName : "");
